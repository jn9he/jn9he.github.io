...
Python, Flask, Tailwind CSS, PostgreSQL, DINOv2, PaddleOCR, EasyOCR, Discogs API.
...
- Served identification through a Flask backend with a Tailwind-based front end for browsing and searching the catalog by genre.
